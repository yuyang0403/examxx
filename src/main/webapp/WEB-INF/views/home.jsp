					...
					<div class="col-md-12">
						<div class="flexslider">
							<div class="flex-caption">
								<!-- Left column -->
								<div class="col-l">
									<p style="text-indent:2em;">1. 如果第一次运行不成功，那就叫它1.0版吧。</p>
									<p style="text-indent:2em;">2. 我想改变这个世界，但我没有源代码。</p>
									<p style="text-indent:2em;">3. 嗨！编译通过了！赶紧打包发布！</p>
									<p style="text-indent:2em;">4. 最难调试的代码是那些你知道不可能有错的代码。</p>
									<p style="text-indent:2em;">5. 我的观点不是不对，只是还处于beta版中。</p>
									<p style="text-indent:2em;">6. 我不是不喜欢社交，只是用户友好性不够。</p>
									<p style="text-indent:2em;">7. 程序员是将咖啡转变成代码的工具。</p>
									<p style="text-indent:2em;">8. 计算机比笔强，比剑强，通常也比程序员强。</p>
								</div>
								<!-- Right column -->
								<div class="col-r">
									
									<p style="text-indent:2em;">9. The more I C, the less I see.</p>
									<p style="text-indent:2em;">10. 编程是10%的科学，20%的创造力，和70%的让这创造力符合科学。</p>
									<p style="text-indent:2em;">11. 程序员的开窍起始于理解“让程序运行起来”和“一个可运行的程序”之间的区别。</p>
									<p style="text-indent:2em;">12. 如果你给人一个程序，你会让他挫折一天；如果你教他去编程，你会让他挫折一辈子。</p>
						...
						<div class="select-test col-xs-6">
							<div style="height: 100px;">
								...
								<div class="select-test-content">
									...
									<a class="btn btn-primary" data-toggle="modal" data-target=".levelup-practice-modal" disabled="disabled"><i class="fa fa-arrow-right"></i>参加练习</a>
						...
						<div class="select-test col-xs-6">
							<div style="height: 100px;">
								...
								<div class="select-test-content">
									...
									<a class="btn btn-primary" data-toggle="modal" data-target=".incorrect-modal" disabled="disabled"><i class="fa fa-arrow-right"></i>参加练习</a>
						...
						<div class="select-test col-xs-6">
							<div style="height: 100px;">
								...
								<div class="select-test-content">
									...
									<a class="btn btn-primary" href="student/practice-test" disabled="disabled"><i class="fa fa-arrow-right"></i>参加练习</a>
								</div>
								<!--//content-->
