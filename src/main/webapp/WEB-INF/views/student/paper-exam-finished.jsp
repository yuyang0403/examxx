				...
				<div class="row">
					<div class="col-xs-3">
						<ul class="nav default-sidenav">
							<li class="active">
								<a href="student/finish-exam/${examPaperId }"> <i class="fa fa-bar-chart-o"></i> 分析报告 </a>
					...
					<div class="col-xs-9">
						...
						<div class="page-content row">
							<table class="table table-bordered" style="margin-top: 25px;">
								...
								<tbody>
									<c:forEach items="${reportResultList }" var="result">
										<tr>
											<td>${result.key }</td>
											<td>${result.value.rightTimes } / ${result.value.sum }</td>
											<td>
												<fmt:formatNumber value="${result.value.rightTimes/result.value.sum }" type="number" pattern="0.00%"/>
											</td>
										</tr>
									</c:forEach>
